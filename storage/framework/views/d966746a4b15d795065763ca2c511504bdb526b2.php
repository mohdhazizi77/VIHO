<?php $__env->startSection('title'); ?>Animated Modal
 <?php echo e($title); ?>
								...
								<div id="animation-box">
									<div class="card">
										<div class="animate-widget">
											<div><img class="img-fluid" src="<?php echo e(asset('assets/images/banner/3.jpg')); ?>" alt="" /></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi.suhaibul\Desktop\LARAVEL\viho_all\Viho-Laravel-8\theme\resources\views/admin/bonus-ui/modal-animated.blade.php ENDPATH**/ ?>