	                  ...
	                  <ul>
	                    ...
	                    <li>
	                      <div class="pricing-plan">
	                        ...
	                        <h5>FREE</h5>
	                        <p> 100 GB Space</p>
	                        <div class="btn btn-outline-primary btn-xs">Selected</div><img class="bg-img" src="<?php echo e(asset('assets/images/dashboard/folder.png')); ?>" alt="">
	                      </div>
	                    </li>
	                    <li>
	                      <div class="pricing-plan">
	                        ...
	                        <h5>$5/month</h5>
	                        <p> 200 GB Space</p>
	                        <div class="btn btn-outline-primary btn-xs">Contact Us</div><img class="bg-img" src="<?php echo e(asset('assets/images/dashboard/folder1.png')); ?>" alt="">
	                      </div>
	                    </li>
	                  </ul>
	                </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi.suhaibul\Desktop\LARAVEL\viho_all\Viho-Laravel-8\theme\resources\views/admin/apps/file-manager.blade.php ENDPATH**/ ?>