        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="list-group">
                            <a class="list-group-item list-group-item-action" href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Cras justo odio</a>
                            <a class="list-group-item list-group-item-action" href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Dapibus ac facilisis in</a>
                            <a class="list-group-item list-group-item-action" href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Morbi leo risus</a>
                            <a class="list-group-item list-group-item-action disabled" href="javascript:void(0)"><img src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Vestibulum at eros</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="list-group">
                            <a class="list-group-item list-group-item-action" href="javascript:void(0)"><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Cras justo odio</a>
                            <a class="list-group-item list-group-item-action" href="javascript:void(0)"><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Dapibus ac facilisis in</a>
                            <a class="list-group-item list-group-item-action" href="javascript:void(0)"><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Morbi leo risus</a>
                            <a class="list-group-item list-group-item-action disabled" href="javascript:void(0)"><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="" />Vestibulum at eros</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi.suhaibul\Desktop\LARAVEL\viho_all\Viho-Laravel-8\theme\resources\views/admin/ui-kits/list.blade.php ENDPATH**/ ?>