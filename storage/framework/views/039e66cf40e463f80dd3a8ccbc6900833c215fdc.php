<?php $__env->startSection('title'); ?>Bookmarks
 <?php echo e($title); ?>
                              ...
                              <div class="row" id="bookmarkData">
                                <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6 xl-50 box-col-6">
                                  <div class="card bookmark-card o-hidden">
                                    <div class="details-website"><img class="img-fluid" src="<?php echo e(asset('assets/images/lightgallry/01.jpg')); ?>" alt="">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6 xl-50 box-col-6">
                                  <div class="card bookmark-card o-hidden">
                                    <div class="details-website"><img class="img-fluid" src="<?php echo e(asset('assets/images/lightgallry/02.jpg')); ?>" alt="">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6 xl-50 box-col-6">
                                  <div class="card bookmark-card o-hidden">
                                    <div class="details-website"><img class="img-fluid" src="<?php echo e(asset('assets/images/lightgallry/03.jpg')); ?>" alt="">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6 xl-50 box-col-6">
                                  <div class="card bookmark-card o-hidden">
                                    <div class="details-website"><img class="img-fluid" src="<?php echo e(asset('assets/images/lightgallry/04.jpg')); ?>" alt="">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6 xl-50 box-col-6">
                                  <div class="card bookmark-card o-hidden">
                                    <div class="details-website"><img class="img-fluid" src="<?php echo e(asset('assets/images/lightgallry/05.jpg')); ?>" alt="">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-4 col-sm-6 xl-50 box-col-6">
                                  <div class="card bookmark-card o-hidden">
                                    <div class="details-website"><img class="img-fluid" src="<?php echo e(asset('assets/images/lightgallry/06.jpg')); ?>" alt="">
                            ...
                            <div class="details-bookmark text-center">
                              <div class="row" id="bookmarkData1">
                                <div class="col-xl-3 col-md-4 xl-50">
                                  <div class="card bookmark-card o-hidden">
                                    <div class="details-website"><img class="img-fluid" src="<?php echo e(asset('assets/images/lightgallry/07.jpg')); ?>" alt="">
                                      <div class="favourite-icon favourite_0" onclick="setFavourite(0)"><a href="javascript:void(0)"><i class="fa fa-star"></i></a></div>
                                      <div class="desciption-data">
                                        <div class="title-bookmark">
                                          <h6 class="title_0">Admin Template</h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi.suhaibul\Desktop\LARAVEL\viho_all\Viho-Laravel-8\theme\resources\views/admin/apps/bookmark.blade.php ENDPATH**/ ?>