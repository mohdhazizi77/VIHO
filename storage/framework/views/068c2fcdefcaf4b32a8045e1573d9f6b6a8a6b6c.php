	                    ...
	                    <div class="card-body">
	                        <div class="media">
	                            ...
	                            <div class="media-body">
	                                ...
	                                <a class="btn btn-primary btn-sm job-apply-btn" href="<?php echo e(route('job-apply')); ?>">Apply for this job</a>
	                            </div>
	                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi.suhaibul\Desktop\LARAVEL\viho_all\Viho-Laravel-8\theme\resources\views/admin/miscellaneous/job-details.blade.php ENDPATH**/ ?>