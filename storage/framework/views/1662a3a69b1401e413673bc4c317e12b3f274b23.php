<?php $__env->startSection('title'); ?>Cards View
 <?php echo e($title); ?>
	                        ...
	                        <div class="job-search">
	                            <div class="card-body">
	                                <div class="media">
	                                    <img class="img-40 img-fluid m-r-20" src="<?php echo e(asset('assets/images/job-search/2.jpg')); ?>" alt="" />
	                                    <div class="media-body">
	                                        <h6 class="f-w-600"><a href="<?php echo e(route('job-details')); ?>">React/React Native Developer </a><span class="pull-right">5 days ago</span></h6>
	                                        <p>San <span>Diego, CA</span></p>
	                                        <ul class="rating">
	                                            <li><i class="fa fa-star font-warning"></i></li>
	                                            <li><i class="fa fa-star font-warning"></i></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi.suhaibul\Desktop\LARAVEL\viho_all\Viho-Laravel-8\theme\resources\views/admin/miscellaneous/job-cards-view.blade.php ENDPATH**/ ?>