<?php $__env->startSection('title'); ?>Typography <?php echo e($title); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-xl-4">
            <div class="card">
              ...
              <div class="card-body typography">
                <h1 class="f-w-600">Heading 1</h1>
                <h2 class="f-w-600">Heading 2</h2>
                <h3 class="f-w-600">Heading 3</h3>
                <h4 class="f-w-600">Heading 4</h4>
                <h5 class="f-w-600">Heading 5</h5>
                <h6 class="f-w-600">Heading 6</h6>
              </div>
            </div>
          </div>
          <div class="col-sm-12 col-xl-4">
          ...
          <div class="col-sm-12 col-xl-6">
            <div class="card">
              <div class="card-header pb-0">
                <h5>Text Color</h5><span>You can Give text color by using txt-* class</span>
              </div>
              <div class="card-body">
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hazizi.suhaibul\Desktop\LARAVEL\viho_all\Viho-Laravel-8\theme\resources\views/admin/ui-kits/typography.blade.php ENDPATH**/ ?>